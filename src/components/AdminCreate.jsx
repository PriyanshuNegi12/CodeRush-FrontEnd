...
// UPDATED: placeholder color changed to slate-400 for visibility
const inputClass =
  ...
  return (
    ...
    <div className="min-h-screen w-full bg-[#3a3d42] px-6 py-10">
      <div className="mx-auto max-w-4xl">
        <h1 className="mb-8 text-3xl font-bold text-white">Create New Problem</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <SectionCard icon={FileText} title="Basic Information">
            <div className="space-y-4">
              <div>
                ...
                <input {...register('title')} className={inputClass} placeholder="e.g. Longest Substring Without Repeating Characters" />
                <FieldError message={errors.title?.message} />
              </div>

              <div>
                <label className="mb-1.5 block text-sm font-medium text-slate-300">Description</label>
                <textarea {...register('description')} rows={5} className={inputClass} placeholder="Full problem statement..." />
              ...
              <div>
                ...
                />
                <span className="mt-1 block text-xs text-slate-500">Separate multiple companies with commas. Optional.</span>
              </div>
          ...
          <SectionCard icon={ListChecks} title="Test Cases">
            ...
            <div className="mb-8">
              ...
              {errors.visibleTestCases?.root && <FieldError message={errors.visibleTestCases.root.message} />}
            ...
            <div>
              ...
              {errors.hiddenTestCases?.root && <FieldError message={errors.hiddenTestCases.root.message} />}
              ...
              {[0, 1, 2].map((index) => {
                ...
                return (
                  <div key={index} className="rounded-xl border border-white/10 bg-white/5 p-4">
                    ...
                    <div className="mb-4">
                      <label className="mb-1.5 block text-sm font-medium text-slate-300">Initial Code</label>
                      <textarea
                    ...
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-slate-300">Reference Solution</label>
                      <textarea
